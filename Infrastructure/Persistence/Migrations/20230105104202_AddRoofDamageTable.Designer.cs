...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230105104202_AddRoofDamageTable")]
    partial class AddRoofDamageTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AssingmentTaskAttachments", b =>
                {
                    b.Property<Guid>("DocumentId")
                        .HasColumnType("uuid")
                        .HasColumnName("documentid");

                    b.Property<Guid>("AssingmentTaskId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("DocumentId", "AssingmentTaskId");

                    b.HasIndex("AssingmentTaskId");

                    b.ToTable("assingmenttaskattachments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.IntakeFormTypeOfLoss", b =>
                {
                    b.Property<Guid>("IntakeFormId")
                        .HasColumnType("uuid")
                        .HasColumnName("intakeformid");

                    b.Property<Guid>("TypeOfLossId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("IntakeFormId", "TypeOfLossId");

                    b.HasIndex("TypeOfLossId");

                    b.ToTable("intakeformstypeofloss");
                });

            modelBuilder.Entity("Domain.Entities.JobCronSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CronSettingString")
                        .HasColumnType("text")
                        .HasColumnName("cronsettingstring");

                    b.Property<string>("ErrorNote")
                        .HasColumnType("text")
                        .HasColumnName("errornote");
            ...
            modelBuilder.Entity("Domain.Entities.RoofDamege", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Entities.AssingmentTaskAttachments", b =>
                {
                    b.HasOne("Domain.Entities.AssignmentTask", "AssignmentTaskInfo")
                        .WithMany("AssingmentTaskAttachmentsInfo")
                        .HasForeignKey("AssingmentTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Document", "DocumentInfo")
                        .WithMany("AssingmentTaskAttachmentsInfo")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AssignmentTaskInfo");
            ...
            modelBuilder.Entity("Domain.Entities.IntakeForm", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.RoofDamege", "RoofDamageInfo")
                        .WithOne("IntakeForm")
                        .HasForeignKey("Domain.Entities.IntakeForm", "RoofDamege")
            ...
            modelBuilder.Entity("Domain.Entities.IntakeFormTypeOfLoss", b =>
                {
                    b.HasOne("Domain.Entities.IntakeForm", "IntakeFormInfo")
                        .WithMany("IntakeFormTypesOfLossInfo")
                        .HasForeignKey("IntakeFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.TypeOfLoss", "TypeOfLossInfo")
                        .WithMany("IntakeFormTypeofLossInfo")
                        .HasForeignKey("TypeOfLossId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IntakeFormInfo");
            ...
            modelBuilder.Entity("Domain.Entities.AssignmentTask", b =>
                {
                    b.Navigation("AssingmentTaskAttachmentsInfo");
                });
            ...
            modelBuilder.Entity("Domain.Entities.IntakeForm", b =>
                {
                    ...
                    b.Navigation("IntakeFormTypesOfLossInfo");
            ...
            modelBuilder.Entity("Domain.Entities.TypeOfLoss", b =>
                {
                    b.Navigation("IntakeFormTypeofLossInfo");
                });
